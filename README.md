Estudando **Engenharia de Software** pelo [Instituto Infnet](https://www.infnet.edu.br/infnet/home/), tenho como objetivo a construção de sistemas robustos no **Back-end** e foco na **Segurança de Aplicações**. Sou entusiasta do ecossistema Java, desenvolvimento seguro e arquitetura de software.
...
* 🛠️ Construindo APIs RESTful seguras e escaláveis com Spring Boot.
* 🛡️ Praticando conceitos de segurança em aplicações e testes de penetração (Kali Linux).
* 🐳 Conteinerização de aplicações com Docker para ambientes de microsserviços.
...
<div align="center" style="margin-top: 15px; display: flex; justify-content: center; gap: 10px; flex-wrap: wrap;">
  ...
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=danielssaugusto&theme=tokyonight&bg_color=0b192c&title_color=38bdf8&text_color=ffffff&icon_color=38bdf8&hide_border=true&show_icons=true" alt="Estatísticas do GitHub" />
</div>
